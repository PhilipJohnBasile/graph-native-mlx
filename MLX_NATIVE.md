...
v0.5.3 keeps language generation, hidden extraction, and optional graph-policy inference in one process while retaining Git, tests, journals, permissions, and promotion in the host effect plane.
